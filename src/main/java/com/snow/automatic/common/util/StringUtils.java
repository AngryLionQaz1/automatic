...
public class StringUtils {
    ...
    /**MD5 签名验证*/
    public static boolean md5Sign(Map<String,Object> data,String sgin){
        ...
        return MD5Utils.MD5(str).equals(sgin);
    }
    ...
    public static void main(String[]args){
      ...
      m.put("millPrice",1);
      m.put("count",1);
      m.put("moneyPassword","sssss");
      System.out.println(md5Sign(m,"A5E232DA91AB886D336ADFA21A1E4DBE"));
